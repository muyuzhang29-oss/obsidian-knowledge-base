...
阶段 4: 实战搭建 (2-3 周)
├── UVM 模板参考 ──→ [[5-验证方法/UVM-Template/00-总览|UVM 模板总览]]
├── 环境搭建实践 ──→ [[2-基础知识/2-UVM/00-环境搭建|环境搭建]]
└── 覆盖率驱动验证 ──→ [[5-验证方法/01-覆盖率|覆盖率]]

阶段 5: 进阶提升 (持续)
├── UVM 源码研究 ──→ [[2-UVM/08-源代码研究|UVM 源码研究]]
├── Factory 机制深入
└── 自定义基类与扩展
```
...
- [[2-基础知识/2-UVM/00-环境搭建|环境搭建]] - UVM 环境搭建
- [[5-验证方法/UVM-Template/00-总览|UVM 模板总览]] - UVM 验证环境模板
- [[2-UVM/08-源代码研究|UVM 源码研究]] - UVM 源码深入学习
- [[00-总索引]] - 返回总索引
