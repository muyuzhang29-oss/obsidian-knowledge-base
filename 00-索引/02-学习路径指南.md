...
| 4 | 寄存器与锁存器 | [[10-Notes/02-寄存器与锁存器]] | always_ff、always_latch、阻塞/非阻塞赋值 |
...
| 脚本 | 笔记 | 用途 |
|------|------|------|
| Makefile | [[07-Scripts/01-Makefile]] | 构建自动化、回归管理 |
| Python 脚本 | [[07-Scripts/02-Python脚本]] | 数据处理、报告生成 |
| Perl 回归脚本 | [[07-Scripts/04-Perl回归脚本]] | 回归测试自动化 |
| Log 解析 | [[07-Scripts/03-Log解析]] | 仿真日志分析 |
