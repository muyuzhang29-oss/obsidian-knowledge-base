...
> 配合 [[00-索引/01-技能树|技能树]] 和 [[00-索引/02-学习进度追踪|学习进度追踪]] 使用效果更佳。
...
| 4 | 寄存器与锁存器 | [[01-SV语法/03-寄存器与锁存器]] | always_ff、always_latch、阻塞/非阻塞赋值 |
| 5 | 时钟块 | [[01-SV语法/04-时钟块Clocking-Block]] | Clocking Block 语法、输入/输出偏斜、信号采样 |
| 6 | SVA 断言 | [[01-SV语法/05-SVA断言]] | 即时断言、并发断言、序列、属性、蕴含操作符 |
| 7 | 随机化约束 | [[01-SV语法/06-随机化约束]] | rand/randc、constraint 块、内联约束、求解冲突 |

### 补充学习

| 主题 | 笔记 | 说明 |
|------|------|------|
| 数字寄存器原理 | [[10-Notes/00-数字寄存器]] | 理解触发器的建立/保持时间 |
| 时隙概念 | [[10-Notes/01-时隙-TimeSlot]] | 理解 Verilog 仿真调度机制 |
...
| 主题 | 笔记 | 说明 |
|------|------|------|
| UVM 源码总览 | [[11-UVM源码学习/UVM源代码研究]] | 理解 UVM 库的内部结构 |
| Factory 机制 | [[11-UVM源码学习/UVM-uvm中的factory机制]] | 类型注册、创建、覆盖 |
| Component 与 Root | [[11-UVM源码学习/UVM-uvm_component与uvm_root]] | 组件层次结构与根节点 |
| TestBench 启动 | [[11-UVM源码学习/UVM-从run_test浅谈TestBench启动]] | run_test 执行流程 |
...
| 脚本 | 笔记 | 用途 |
|------|------|------|
| Makefile | [[07-Scripts/00-Makefile]] | 构建自动化、回归管理 |
| Python 脚本 | [[07-Scripts/00-Python脚本]] | 数据处理、报告生成 |
| Perl 回归脚本 | [[07-Scripts/02-Perl回归脚本]] | 回归测试自动化 |
| Log 解析 | [[07-Scripts/01-Log解析]] | 仿真日志分析 |
...
| 阶段 | 笔记 | 内容 |
|------|------|------|
| 项目概述 | [[08-Projects/01-SPI验证/00-项目概述]] | 验证目标、范围、计划 |
| 验证计划 | [[08-Projects/01-SPI验证/01-验证计划]] | 功能点、覆盖率目标、测试策略 |
| 环境架构 | [[08-Projects/01-SPI验证/02-环境架构]] | UVM 环境搭建、组件连接 |
| 测试用例 | [[08-Projects/01-SPI验证/03-测试用例]] | 定向测试、随机测试、边界测试 |
| 覆盖率模型 | [[08-Projects/01-SPI验证/04-覆盖率模型]] | 功能覆盖率、代码覆盖率目标 |

#### AXI 验证项目

| 阶段 | 笔记 | 内容 |
|------|------|------|
| 项目概述 | [[08-Projects/02-AXI验证/00-项目概述]] | 验证目标、范围、计划 |
| 验证计划 | [[08-Projects/02-AXI验证/01-验证计划]] | 功能点、覆盖率目标、测试策略 |
| 环境架构 | [[08-Projects/02-AXI验证/02-环境架构]] | UVM 环境搭建、多 Agent 架构 |
| 测试用例 | [[08-Projects/02-AXI验证/03-测试用例]] | burst 传输、outstanding、乱序测试 |
...
> 3. 遇到问题及时记录到 [[09-Issues/00-索引|问题追踪]] 目录
...
> - [ ] 能独立分析覆盖率空洞并编写针对性测试
> - [ ] 积累至少 5 个问题解决方案到 [[09-Issues/00-索引|问题追踪]]
...
| 主题 | 笔记 | 说明 |
|------|------|------|
| 源码研究总览 | [[11-UVM源码学习/UVM源代码研究]] | UVM 库整体架构 |
| Factory 机制源码 | [[11-UVM源码学习/UVM-uvm中的factory机制]] | 类型注册与覆盖实现 |
| Component 层次源码 | [[11-UVM源码学习/UVM-uvm_component与uvm_root]] | 组件树构建过程 |
| TestBench 启动源码 | [[11-UVM源码学习/UVM-从run_test浅谈TestBench启动]] | run_test 执行细节 |
...
| 学习进度 | [[00-索引/02-学习进度追踪]] | 学习进度与里程碑记录 |
| 协议索引 | [[03-Protocol/00-协议索引]] | 全部协议笔记索引 |
| 工具索引 | [[04-Tools/00-工具索引]] | 全部工具笔记索引 |
| 项目索引 | [[08-Projects/00-项目索引]] | 验证项目索引 |
| 问题追踪 | [[09-Issues/00-索引]] | 常见问题与解决方案 |
| 脚本索引 | [[07-Scripts/00-脚本索引]] | 脚本工具索引 |
...
| [[00-索引/02-学习进度追踪\|学习进度]] | 学习进度与里程碑 |
| [[00-索引/03-健康报告\|健康报告]] | 知识库健康状态 |
...
| 项目实战 | [[08-Projects/00-项目索引]] |
| UVM 源码 | [[11-UVM源码学习/UVM源代码研究]] |
