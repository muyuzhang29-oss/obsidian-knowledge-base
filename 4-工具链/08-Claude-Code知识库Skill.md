...
Claude: [逐段分析]
你: 放进知识库
→ 自动创建 07-Scripts/04-Perl回归脚本.md
```
...
→ 读取 2-UVM/02-config_db.md，在合适位置追加内容
```
...
| 主题 | 目标目录 |
|------|---------|
| SV 语法、数据类型、编码 | `1-SV语法/` |
| UVM（phase、config_db、sequence） | `2-UVM/` |
| 通信协议（SPI/AXI/APB/I2C/UART） | `3-协议规范/<协议名>/` |
| EDA 工具（xrun/imc/GVim/Linux） | `4-工具链/<工具名>/` |
| 验证方法、覆盖率、FMEA | `5-验证方法/` |
