...
- [[4-工具链/06-Verdi/00-Verdi|Verdi 调试工具]] - Verdi 波形调试
- [[2-UVM/08-源代码研究|UVM 源码研究]] - UVM 验证方法学
- [[3-协议规范/AXI/00-AXI|AXI 协议]] - AXI 协议（验证常用）

### 常用文件模板

- [[7-脚本工具/01-Makefile|Makefile]] - Makefile 模板
- [[7-脚本工具/02-Python脚本|Python脚本]] - 运行脚本模板
