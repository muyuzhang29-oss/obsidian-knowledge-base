...
实际项目的 Xcelium 编译/仿真 Makefile 见 [[7-脚本工具/06-仿真环境脚本]]，含：
...
- [[7-脚本工具/07-Makefile通用模板]] — 带完整中文注释的通用模板（推荐）
- [[7-脚本工具/06-仿真环境脚本]] — 项目实际 Makefile + wave.tcl 说明
- [[7-脚本工具/00-脚本索引]] — 返回脚本索引
