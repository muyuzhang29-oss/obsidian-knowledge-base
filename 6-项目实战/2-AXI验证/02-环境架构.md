...
前置笔记：[[00-项目概述]] | [[01-验证计划]] | [[5-验证方法/UVM-Template/00-总览|UVM 验证模板]]
...
interface axi_if(input logic clk, input logic rst_n);
  ...
  // SVA 断言
  // 参考: [[5-验证方法/UVM-Template/Driver握手时序陷阱|握手时序陷阱]]
endinterface
```

参考：[[5-验证方法/UVM-Template/01-interface|Interface 模板]]
...
参考：[[5-验证方法/UVM-Template/09-env|Env 模板]] | [[2-UVM/06-TLM通信|TLM 通信]]
...
- [[5-验证方法/UVM-Template/03-sequence|Sequence 模板]]
...
### 常见陷阱
- [[5-验证方法/UVM-Template/Driver握手时序陷阱|Driver 握手时序陷阱]]
- [[5-验证方法/UVM-Template/UVM-Analysis-Port数据流|Analysis Port 数据流]]
- [[5-验证方法/UVM-Template/uvm_analysis_imp多端口陷阱|uvm_analysis_imp 多端口陷阱]]
